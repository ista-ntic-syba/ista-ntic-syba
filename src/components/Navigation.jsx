        ...
        <div className="flex items-center justify-between py-4">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <motion.a 
              ...
              className="text-[#003366] font-medium border-b-2 border-[#003366] cursor-pointer"
            ...
            <motion.a 
              ...
              className="text-gray-600 hover:text-[#003366] cursor-pointer"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              Actualités
            ...
            <div className="relative">
              <motion.button
                className="flex items-center text-gray-600 hover:text-[#003366] space-x-1"
          ...
          {isMenuOpen && (
            ...
            >
              <div className="py-4 border-t space-y-4">
                <motion.a 
                  onClick={() => onNavigate('home')} 
                  className="block text-[#003366] font-medium cursor-pointer"
                  whileHover={{ x: 6 }}
                >
                  Accueil
                </motion.a>
